...
def check_syntax() -> None:
    ...
    *Note - while this function does not return any value, the script will exit with different codes depending on the outcome:
    ...
    for filename in sys.argv[1:]:
        ...
        # check for syntax error in the python file. if there is any syntax error, exit immediately with -1 code
        try:
...
if __name__ == "__main__":
    check_syntax()
    # to run script, python3 checker.py <python file 1> <python file 2> ... <python file n>
