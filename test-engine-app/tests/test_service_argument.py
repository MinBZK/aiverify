...
class TestCollectionServiceArgument:
    ...
    def test_init_invalid_inputs(
        self, validation_schema, validation_type, expected_output
    ):
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                ...
                "",
                ServiceValidationType.VALIDATE_DATASET,
                '{"serviceId":"",' '"filePath":"training_1.sav"}',
                True,
                "",
            ),
            # No / Empty filepath
            ...
            (
                ...
                "",
                ServiceValidationType.VALIDATE_DATASET,
                '{"serviceId":"service:646d77460da1d597e3ca980d",' '"filePath":""}',
                True,
                "",
            ),
            # No / Empty mode
            ...
            (
                ...
                "",
                ServiceValidationType.VALIDATE_MODEL,
                '{"serviceId":"service:646d77760da1d597e3ca981d",' '"mode":"upload"}',
                False,
                "The inputs do not meet the validation schema rules for service:646d77760da1d597e3ca981d",
            ),
            (
    ...
    def test_parse(
        ...
        with mocker.patch.object(
            ...
            new_argument = ServiceArgument(
                "test_engine_app/validation_schemas", validation_type
            )
    ...
    def test_parse_exception(
        self, validation_type, args, expected_output, expected_error_message
    ):
        new_argument = ServiceArgument(
            "test_engine_app/validation_schemas", validation_type
        )
