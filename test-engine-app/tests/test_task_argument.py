...
class TestCollectionTaskArgument:
    @pytest.mark.parametrize(
        ...
        [
            ...
            ("None", "None/test_engine_task_schema.json"),
        ],
    )
    ...
    def test_parse(
        ...
        with mocker.patch.object(
            ...
            PluginController, "get_plugin_information", return_value=None
        ):
    ...
    @pytest.mark.parametrize(
        ...
        [
            (None, False, "The inputs do not meet the validation rules"),
            ("None", False, "Expecting value: line 1 column 1 (char 0)"),
            ([], False, "The inputs do not meet the validation rules"),
            ({}, False, "The inputs do not meet the validation rules"),
            ("", False, "The inputs do not meet the validation rules"),
            (1234, False, "The inputs do not meet the validation rules"),
        ],
    )
